...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A10M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST {  30.39,  30.39 }
    #define DEFAULT_Ki_LIST {   3.86,   3.86 }
    #define DEFAULT_Kd_LIST { 59.74, 59.74 }
  #else
    #define  DEFAULT_Kp 34.81
    #define  DEFAULT_Ki 4.21
    #define  DEFAULT_Kd 72.00
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 86.19   // 175.68 189.95
  #define DEFAULT_bedKi 16.70    //  34.59  37.40
  #define DEFAULT_bedKd 296.56   // 223.07 241.19
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, 0, -2.08 }
